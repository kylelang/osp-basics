...
Although there are three valid assignment operators: `<-`, `->`, `=`, only the left-facing arrow is recommended by most
style guides.
...
* This isn't legal R code. This command attempts to assign the value `y` to the variable `7`, but variable names can't
begin with numbers.
* This is technically valid assignment, but putting the variable on the right-hand side of the assignment operator is
